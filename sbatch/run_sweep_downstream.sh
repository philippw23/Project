...
#SBATCH --output="/mnt/nfs/homedirs/%u/Project/logs/slurm-%j_biomedclip_downstream_sweep_3class.out"
...
SWEEP_ID="philipp-wiese/biomedclip-downstream/2jl18gkt"   # e.g. "philipp-wiese/philipp-wiese/abc12345"
