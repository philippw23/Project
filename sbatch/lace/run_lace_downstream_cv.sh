...
#SBATCH --output="/mnt/nfs/homedirs/%u/Project/logs/lace/slurm-%j_lace_downstream_cv_A4_binary_rocauc.out"
...
CV_DIR=$home_dir/Project/results/lace_v2_pretrain/run_20260824_210717
