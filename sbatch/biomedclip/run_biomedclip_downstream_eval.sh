#!/bin/bash
#SBATCH --job-name=biomedclip_downstream_eval
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=1
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=4
#SBATCH --time=01:00:00
#SBATCH --output="/mnt/nfs/homedirs/%u/Project/logs/biomedclip/slurm-%j_biomedclip_downstream_eval.out"
...
HEAD_CHECKPOINT=$home_dir/Project/results/biomedclip_downstream/run_.../best_head.pt   # <-- set this
...
python $home_dir/Project/src/biomedclip/train/downstream_eval.py \
