...
CV_DIR=$home_dir/Project/data/internal_dataset/cv_img_text   # e.g. $home_dir/Project/data/internal_dataset/cv
CV_PATTERN="split_fold*.json"                       # glob for fold files inside CV_DIR (empty = script default "split_fold*.json")
...
LOG_FILE="$home_dir/Project/logs/img_text/slurm-${SLURM_JOBID}_bs${BATCH_SIZE}_${tune_tag}_lr${LR}.out"
exec > "$LOG_FILE" 2>&1
