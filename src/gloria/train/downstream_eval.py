...
Optional:
    ...
    --checkpoint <path>       override the GLoRIA backbone path stored in the checkpoint
...
def parse_args(argv=None) -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Evaluate a saved GLoRIA downstream head (no training).")
    ...
    p.add_argument("--checkpoint", default=None,
                   help="Optional GLoRIA backbone checkpoint path override.")
