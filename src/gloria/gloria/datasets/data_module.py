...
class BoneTumorDataModule(pl.LightningDataModule):
    def __init__(self, cfg):
        super().__init__()
        self.cfg = cfg
        self.dataset = bonetumor_dataset.BoneTumorPretrainingDataset
        self.collate_fn = bonetumor_dataset.multimodal_collate_fn
